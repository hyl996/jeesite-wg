...
@Table(name="${_prefix}sys_user", alias="a", columns={
		...
		@Column(name="pk_psndoc", attrName="pkPsndoc.pkPsndoc" ,label="人员", isUpdateForce=true), 
	}, joinTable={
		...
		@JoinTable(type=Type.LEFT_JOIN, entity=BdPsndoc.class, alias="bd", on="bd.pk_psndoc = a.pk_psndoc", attrName="pkPsndoc",
		columns={@Column(name="pk_psndoc", attrName="pkPsndoc", label="主键", isPK=true),
			@Column(name="code", attrName="code", label="人员编码", isQuery=false),
			@Column(name="name", attrName="name", label="人员名称", isQuery=false)}),
	},
