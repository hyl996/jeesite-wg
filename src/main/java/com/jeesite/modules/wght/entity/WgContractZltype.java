 ...
 * @version 2019-10-31
 */
@Table(name="wg_contract_zltype", alias="a", columns={
		@Column(name="pk_contract_zltype", attrName="pkContractZltype", label="主键", isPK=true),
...
}, orderBy="a.pk_contract_zltype ASC"
)
public class WgContractZltype extends DataEntity<WgContractZltype> {
	
	private static final long serialVersionUID = 1L;
	private String pkContractZltype;		// 主键
	...
	public WgContractZltype() {
		this(null);
	}

	public WgContractZltype(WgContract pkContract){
		this.pkContract = pkContract;
	}
	
	public String getPkContractZltype() {
		return pkContractZltype;
	}

	public void setPkContractZltype(String pkContractZltype) {
		this.pkContractZltype = pkContractZltype;
	}
