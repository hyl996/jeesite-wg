 ...
 * @version 2019-10-31
 */
@Table(name="wg_contract_wyfcf", alias="a", columns={
		@Column(name="pk_contract_wyfcf", attrName="pkContractWyfcf", label="主键", isPK=true),
...
},extWhereKeys="dsf", orderBy="a.pk_contract_wyfcf ASC"
)
public class WgContractWyfcf extends DataEntity<WgContractWyfcf> {
	
	private static final long serialVersionUID = 1L;
	private String pkContractWyfcf;		// 主键
	...
	public WgContractWyfcf() {
		this(null);
	}

	public WgContractWyfcf(WgContract pkContract){
		this.pkContract = pkContract;
	}

	public String getPkContractWyfcf() {
		return pkContractWyfcf;
	}

	public void setPkContractWyfcf(String pkContractWyfcf) {
		this.pkContractWyfcf = pkContractWyfcf;
	}
