 ...
 * @version 2019-10-31
 */
@Table(name="wg_contract_ywcf", alias="a", columns={
		@Column(name="pk_contract_ywcf", attrName="pkContractYwcf", label="主键", isPK=true),
...
},extWhereKeys="dsf", orderBy="a.pk_costproject,a.dstartdate "
)
public class WgContractYwcf extends DataEntity<WgContractYwcf> {
	
	private static final long serialVersionUID = 1L;
	private String pkContractYwcf;		// 主键
	...
	public WgContractYwcf() {
		this(null);
	}

	public WgContractYwcf(WgContract pkContract){
		this.pkContract = pkContract;
	}

	public String getPkContractYwcf() {
		return pkContractYwcf;
	}

	public void setPkContractYwcf(String pkContractYwcf) {
		this.pkContractYwcf = pkContractYwcf;
	}
