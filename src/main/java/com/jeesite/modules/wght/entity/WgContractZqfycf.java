 ...
 * @version 2019-10-31
 */
@Table(name="wg_contract_zqfycf", alias="a", columns={
		@Column(name="pk_contract_zqfycf", attrName="pkContractZqfycf", label="主键", isPK=true),
		...
		@Column(name="ndegree", attrName="ndegree", label="精度"),
...
},extWhereKeys="dsf", orderBy="a.pk_contract_zqfycf ASC"
)
public class WgContractZqfycf extends DataEntity<WgContractZqfycf> {
	
	private static final long serialVersionUID = 1L;
	private String pkContractZqfycf;		// 主键
	...
	public WgContractZqfycf() {
		this(null);
	}

	public WgContractZqfycf(WgContract pkContract){
		this.pkContract = pkContract;
	}

	public String getPkContractZqfycf() {
		return pkContractZqfycf;
	}

	public void setPkContractZqfycf(String pkContractZqfycf) {
		this.pkContractZqfycf = pkContractZqfycf;
	}
