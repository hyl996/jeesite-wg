 ...
 * @version 2019-10-30
 */
@Table(name="bd_custtype", alias="a", columns={
		@Column(name="pk_custtype", attrName="pkCusttype", label="主键", isPK=true),
	...
	}, orderBy="a.tree_sorts, a.pk_custtype"
)
public class BdCusttype extends TreeEntity<BdCusttype> {
	
	private static final long serialVersionUID = 1L;
	private String pkCusttype;		// 主键
	...
	public BdCusttype(String id){
		super(id);
	}
	
	@Override
	public BdCusttype getParent() {
		return parent;
	}

	@Override
	public void setParent(BdCusttype parent) {
		this.parent = parent;
	}
	
	public String getPkCusttype() {
		return pkCusttype;
	}

	public void setPkCusttype(String pkCusttype) {
